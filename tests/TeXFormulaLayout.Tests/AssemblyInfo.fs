...
[<assembly: AssemblyTitleAttribute("TeXFormulaLayout.Tests")>]
[<assembly: AssemblyProductAttribute("TeXFormulaLayout")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "TeXFormulaLayout.Tests"
    let [<Literal>] AssemblyProduct = "TeXFormulaLayout"
